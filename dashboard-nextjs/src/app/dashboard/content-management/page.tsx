...
const ContentManagementPage = () => {
  ...
  return (
    <Box>
      ...
      <Dialog fullWidth maxWidth='md' open={openAnimeDialog} onClose={handleToggleAnimeDialog}>
        <DialogTitle>
      ...
      <Dialog fullWidth maxWidth='md' open={openViewStudioDialog} onClose={handleToggleViewStudioDialog}>
        <DialogTitle>
          <Box display='flex' justifyContent='space-between' alignItems='center'>
      ...
      <Dialog fullWidth maxWidth='md' open={openViewGenreDialog} onClose={handleToggleViewGenreDialog}>
        <DialogTitle>
          <Box display='flex' justifyContent='space-between' alignItems='center'>
